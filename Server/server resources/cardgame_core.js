...
function onResize(){
	...
	//card elements:
	/*
	baseDimensions.card_width = 160*sizeFactor;
	baseDimensions.card_height = 240*sizeFactor;
	baseDimensions.top_space_card = 30*sizeFactor;
	baseDimensions.image_space_card = 110*sizeFactor;
	baseDimensions.comment_card = 70*sizeFactor;
	baseDimensions.atk_def_rank = 30*sizeFactor;
	baseDimensions.atk_def_gap = 60*sizeFactor;
	*/
